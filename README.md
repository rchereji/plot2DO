...
**plot2DO** will create a new folder called **2D_occupancy**, which will contain the 2D occupancy, saved in *RData* format, and the plots, saved in a *pdf* format. An example figure generated by **plot2DO** (Dataset: *439J_3_H4_25U_IP*; Reference: TSS; 50 bp ≤ L ≤ 200 bp; Upstream/Downstream window = 1 kb) is shown below:
![](misc/img.png)
